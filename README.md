...
This repository contains the sources for the napari documentation, which is published at [napari.org](https://napari.org). This includes tutorials, how-tos and other narrative documentation.

* The autogenerated API documentation is extracted from the source code docstrings, which live on https://github.com/napari/napari.
* When a pull request in this repository is merged, its changes are deployed to the [development docs](https://napari.org/dev/index.html).
* Once a new version of napari is released, those changes become part of the [stable docs](https://napari.org/stable/index.html), which is the default version shown at [napari.org](https://napari.org).
