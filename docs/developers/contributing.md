...
````{note}
If you are running any of these examples on a Jupyter notebook, the block
...
is not necessary, but it is required when running the examples as scripts or
directly from the IPython console.
````
## Adding icons
