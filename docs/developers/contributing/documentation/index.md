...
1. [**Contributing without a local setup**](#contributing-to-the-napari-documentation-without-a-local-setup): This is a simpler approach that allows you
   ...
   with Git or the command line. You can also find the "Edit on GitHub" button in the right sidebar which allows you to easily edit directly on GitHub (press the edit pencil icon). However, some pages are autogenerated and do not have a coresponding page on GitHub.
