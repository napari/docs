...
1. Some of the documentation about [plugins](https://napari.org/plugins) resides in
...
1. The [examples gallery](https://napari.org/gallery) is generated from Python source files and changes to the gallery should be made to the
...
1. The [API reference documentation](https://napari.org/dev/api/index.html) is autogenerated from the napari source code docstrings.
...
1. From Git Bash, `cd` to the napari docs repository and run `make docs` or other `make` commands to build the documentation.
...
1. Run `make docs` or other `make` commands to build the documentation.
